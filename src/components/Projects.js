...
const Projects = () => {
  return (
    <div className="px-16 lg:px-24 flex flex-col gap-8 items-center bg-black text-white py-16">
      ...
      <div className="lg:flex gap-12 lg:justify-around mb-12">
        <div className="space-y-2 relative h-[200px] lg:h-max-fit">
          ...
          <div className="flex gap-x-12 items-end absolute left-0 bottom-4">
      ...
      <div className="lg:flex lg:flex-row-reverse gap-12 lg:justify-around mb-12">
        <div className="space-y-2 relative h-[200px] lg:h-max-fit">
